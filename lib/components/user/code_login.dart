...
final loginInfo = StateProvider<Map<String, String>>(
    (ref) => {'phone': '', 'code': '', 'isAgree': "0"});
final isAgree = StateProvider<int>((ref) => 0);
final isShowCode = StateProvider<int>((ref) => 0);
...
class CodeLoginWidget extends ConsumerStatefulWidget{
  const CodeLoginWidget({super.key});
...
class CodeLoginState extends ConsumerState<CodeLoginWidget>{
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          onPressed: (){
                            ...
                            if(coolDown > 0){
                              ToastUtil.error('请求冷却中');
                              return;
                            }
                            HttpUser.sendCode(phone, (isSuccess, data, msg, code) {
                              if(isSuccess){
                                //ToastUtil.hint('发送成功');
                                if(timer != null){
                                  timer!.cancel();
                          ...
                          child: Container(
                            ...
                            child: 
                            coolDown <= 0 ?
                            const Text('获取', style: TextStyle(color: Colors.black54),) :
                            Text('获取($coolDown)', style: const TextStyle(color: Colors.grey),)
                          )
                        )
                      ],
                    ),
                    ...
                    ElevatedButton(
                      ...
                      onPressed: (){
                        ...
                        HttpUser.codeLogin(phone, captcha, (isSuccess, data, msg, code) async { 
                          if(isSuccess){
